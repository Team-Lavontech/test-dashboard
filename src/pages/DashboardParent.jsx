...
import { MdOutlineToday, MdCalendarMonth, MdOutlineFileDownload } from "react-icons/md";
...
const DashboardParentPage = () => {
  ...
  return (
    <Layout>
      <div className="p-8">
        <div className="pt-4 flex flex-items justify-between">
          <div>
  ...
  <button className="flex items-center font-bold p-2 bg-red-600"><MdOutlineFileDownload /><span className="ml-2">DOWNLOAD REPORTS</span></button>
</div>
        </div>
        <div>
